...
APICAST_PROJECT_NAME=demo
APICAST_APP_NAME_PREFIX=demo
APICAST_TENANT=demo
APICAST_TENANT_ACCESS_TOKEN=fcd052e6ab1c8e10672691086f287c1d
...
oc new-app --file ./apicast-ub-demo-2.6.yml \
